#!/usr/bin/env python3
"""Train the square classifier on cropped board squares.

Consumes `cache/square_crops_index.csv`, computes normalization stats,
trains a ConvNeXt-Tiny classifier, and saves weights + artifacts in `models/`.
"""
