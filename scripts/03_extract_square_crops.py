#!/usr/bin/env python3
"""Extract square crops from frames and build a crop index CSV.

Reads labeled frames from `cache/frames_with_square_labels.csv`, writes cropped
square images to `cache/square_crops/`, and saves `cache/square_crops_index.csv`.
"""
