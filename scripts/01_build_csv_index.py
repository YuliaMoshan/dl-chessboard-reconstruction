#!/usr/bin/env python3
"""Build a frame-level index from per-game CSV labels and images.

Creates train/valid/test splits, flags occluded frames, and logs missing or
conflicting labels to CSV files under `cache/`.
"""
