#!/usr/bin/env python3
"""Create side-by-side visuals of raw frames and predicted boards.

Uses `results/inference_debug.csv` and `cache/frames_index.csv` to match
raw frames with reconstructed board images and saves them to `results/side_by_side/`.
"""
