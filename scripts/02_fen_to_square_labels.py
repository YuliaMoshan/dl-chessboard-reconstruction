#!/usr/bin/env python3
"""Expand FEN strings into per-square labels for supervised training.

Reads `cache/frames_index.csv` and writes `cache/frames_with_square_labels.csv`
with 64 label columns (a8 -> h1 order).
"""
